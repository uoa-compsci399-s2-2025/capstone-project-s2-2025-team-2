       ...
       ">
           ...
           ">
               ...
               <div className="ml-[1rem] md:ml-[0.5rem]">
                   ...
                   <h2 className="text-black dark:text-white text-[1.5rem] font-medium dark:font-light md:tracking-wide md:mt-[0.4rem]">{name}</h2>
                   <div className="hidden md:w-[11.2rem] md:flex md:flex-col">
                       <div className="md:flex md:justify-between w-[8.5rem] md:mt-[0.4rem]">
                           <div className="">
                               ...
                               <p className="text-green-100 dark:text-purple-100 font-light text-[0.8rem]">Condition</p>
                           </div>
                           <div>
                               <p className="text-dark-gray dark:text-gray-200 font-light text-[0.8rem]">{listedDate}</p>
                               <p className="text-dark-gray dark:text-gray-200 font-light text-[0.8rem]">{expiryDate}</p>
                               <p className="text-dark-gray dark:text-gray-200 font-light text-[0.8rem]">{condition}</p>
                           </div>
                       </div>
                       <div className="flex justify-between mt-[1rem]">
                           <div>
                               <p className="text-dark-gray font-extralight italic text-[0.7rem] dark:text-secondary">Quantity</p>
                               <h2 className="text-dark-gray font-extralight italic text-[1.7rem] dark:text-gray-200">{quantity}</h2>
                           </div>
                           <div className="text-right">
                               <p className="text-dark-gray font-extralight italic text-[0.7rem] dark:text-secondary">Purity</p>
                               <h2 className="text-dark-gray font-extralight italic text-[1.7rem] dark:text-gray-200">{purity}%</h2>
                           </div>
                       </div>
                   </div>
