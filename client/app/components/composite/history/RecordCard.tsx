...
const RecordCard = ({
  ...
  const statusClasses =
    statusKey === "pending"
      ? "bg-yellow-500/40 backdrop-blur-sm border border-yellow-300/90"
      : statusKey === "approved"
        ? "bg-green-500/40 backdrop-blur-sm border border-green-300/90"
        : statusKey === "canceled"
          ? "bg-red-500/40 backdrop-blur-sm border border-red-300/90"
