          ...
          <div className="bg-green-300 rounded-[10px] shadow-[0_4px_6px_rgba(0,0,0,0.4)]">
            ...
            <div className="flex bg-gray-300 p-[2rem] rounded-b-[10px]">
              <div className="flex-[0.25]">
                <p className="text-dark-gray font-bold mb-[0.7rem]">
                  Category - Chemical
                </p>
                <p className="text-dark-gray font-bold mb-[0.7rem]">
                  Condition - New
              ...
              <div className="flex-[0.75] ml-[1rem]">
                <p className="text-dark-gray">
                  ...
                  completely full. I originally bought it for a project but
                  ended up not needing it, so it’s brand new and has been stored
                  properly in a cool, dark space since purchase. Expiry is 2026,
                  so plenty of shelf life left. lorem ipsum lorem ipsum lorem
                  ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem
                  ipsum lorem ipsum lorem ipsum lorem
                </p>
                <div className="mt-[3rem] flex">
                  <div className="mx-[0.4rem] bg-light-gray text-dark-gray px-[0.8rem] rounded-[0.7rem] font-family-sans tracking-widest">
                    Tag
                  </div>
                  <div className="mx-[0.4rem] bg-light-gray text-dark-gray px-[0.8rem] rounded-[0.7rem] font-family-sans tracking-widest">
                    Tag
